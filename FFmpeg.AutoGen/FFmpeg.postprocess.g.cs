...
namespace FFmpeg.AutoGen
{
    public unsafe static partial class ffmpeg
    {
        ...
        public static extern void pp_postprocess([MarshalAs(UnmanagedType.LPArray, SizeConst=3)] sbyte*[] @src, [MarshalAs(UnmanagedType.LPArray, SizeConst=3)] int[] @srcStride, [MarshalAs(UnmanagedType.LPArray, SizeConst=3)] int*[] @dst, [MarshalAs(UnmanagedType.LPArray, SizeConst=3)] int[] @dstStride, int @horizontalSize, int @verticalSize, int* @QP_store, int @QP_stride, void* @mode, void* @ppContext, int @pict_type);
