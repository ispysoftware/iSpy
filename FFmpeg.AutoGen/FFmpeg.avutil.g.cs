...
namespace FFmpeg.AutoGen
{
    ...
    public unsafe static partial class ffmpeg
    {
        ...
        [DllImport(libavutil, EntryPoint = "av_log_format_line2", CallingConvention = CallingConvention.Cdecl)]
        public static extern int av_log_format_line2(void* @ptr, int @level, [MarshalAs(UnmanagedType.LPStr)] string @fmt, int @vl, IntPtr @line, int @line_size, int* @print_prefix);
        ...
        [DllImport(libavutil, EntryPoint = "av_audio_fifo_peek_at", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(libavutil, EntryPoint = "av_buffer_pool_init2", CallingConvention = CallingConvention.Cdecl)]
        ...
        public static extern int av_image_fill_pointers([MarshalAs(UnmanagedType.LPArray, SizeConst=4)] sbyte*[] @data, AVPixelFormat @pix_fmt, int @height, int* @ptr, [MarshalAs(UnmanagedType.LPArray, SizeConst=4)] int[] @linesizes);
